...
aa3f72f (se modificaron archivos)
fcbfbfb (se modificaron archivos)
...
#¿Como crear un commit en Git?
be60ca3 (Todos los tps guardados y editados)
...
f51ac59 (Todos los tps guardados y editados)
